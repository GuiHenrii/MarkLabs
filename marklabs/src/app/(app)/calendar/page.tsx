...
// ─── Mock data ────────────────────────────────────────────────────────────────
const mockPosts = [
  { id: "1", date: "2026-08-12", time: "09:30", platform: "INSTAGRAM", content: "Post de boas-vindas de agosto!", status: "PUBLISHED", color: "#e1306c" },
  { id: "2", date: "2026-08-12", time: "14:00", platform: "FACEBOOK", content: "Dica da semana para empreendedores", status: "PUBLISHED", color: "#1877f2" },
  { id: "3", date: "2026-08-13", time: "10:00", platform: "LINKEDIN", content: "Artigo: Como crescer no LinkedIn", status: "SCHEDULED", color: "#0a66c2" },
  { id: "4", date: "2026-08-14", time: "16:30", platform: "INSTAGRAM", content: "Nos bastidores da empresa ✨", status: "SCHEDULED", color: "#e1306c" },
  { id: "5", date: "2026-08-15", time: "09:00", platform: "FACEBOOK", content: "Promoção especial de fim de semana!", status: "SCHEDULED", color: "#1877f2" },
  { id: "6", date: "2026-08-17", time: "11:00", platform: "INSTAGRAM", content: "Conhecendo nossa equipe", status: "SCHEDULED", color: "#e1306c" },
  { id: "7", date: "2026-08-18", time: "14:00", platform: "LINKEDIN", content: "Novidades da empresa — agosto 2026", status: "SCHEDULED", color: "#0a66c2" },
  { id: "8", date: "2026-08-20", time: "09:30", platform: "YOUTUBE", content: "Novo vídeo: Tutorial completo", status: "DRAFT", color: "#ff0000" },
  { id: "9", date: "2026-08-22", time: "18:00", platform: "INSTAGRAM", content: "Fechamento da semana 🎉", status: "DRAFT", color: "#e1306c" },
  { id: "10", date: "2026-08-25", time: "10:00", platform: "FACEBOOK", content: "Evento especial: inscreva-se já!", status: "SCHEDULED", color: "#1877f2" },
  { id: "11", date: "2026-08-26", time: "12:00", platform: "INSTAGRAM", content: "Oferta imperdível só hoje!", status: "SCHEDULED", color: "#e1306c" },
  { id: "12", date: "2026-08-28", time: "09:00", platform: "LINKEDIN", content: "Relatório de crescimento do mês", status: "FAILED", color: "#0a66c2" },
];
...
export default function CalendarPage() {
  ...
  const postsByDate = mockPosts.reduce<Record<string, typeof mockPosts>>((acc, post) => {
      ...
      <main style={{ padding: "24px", display: "grid", gridTemplateColumns: "1fr 320px", gap: "20px", flex: 1, alignItems: "start" }} className="animate-fade-in">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px", position: "sticky", top: "88px" }}>
              ...
              <>
                ...
                {selectedPosts.length > 0 ? (
                  ...
                  <div style={{ textAlign: "center", padding: "24px 0" }}>
                    ...
                    <Link href="/compose" style={{ fontSize: "12px", color: "#818cf8", textDecoration: "none", display: "inline-block", marginTop: "8px" }}>
          ...
          <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "14px", padding: "16px" }}>
            ...
            {Object.entries(
              mockPosts.reduce<Record<string, number>>((acc, p) => {
