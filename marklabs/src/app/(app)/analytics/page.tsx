...
export default function AnalyticsPage() {
  ...
  return (
    <>
      ...
      <main style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "24px", flex: 1 }} className="animate-fade-in">
            ...
            {periods.map((p) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: "7px",
                  border: "none",
                  background: period === p ? "linear-gradient(135deg, #6366f1, #4f46e5)" : "transparent",
                  color: period === p ? "#fff" : "var(--text-muted)",
                  fontSize: "13px",
                  fontWeight: period === p ? 600 : 400,
                  cursor: "pointer",
                  transition: "all 0.15s ease",
                  boxShadow: period === p ? "0 0 10px rgba(99,102,241,0.3)" : "none",
                }}
              >
                {p}
              </button>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "14px" }}>
          {[
            { title: "Alcance Total", value: "284.7K", change: "+18%", icon: Eye, color: "#6366f1" },
            { title: "Novos Seguidores", value: "+2.4K", change: "+12%", icon: Users, color: "#8b5cf6" },
          ...
          <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "14px", padding: "20px" }}>
            ...
            <ResponsiveContainer width="100%" height={180}>
              <PieChart>
                ...
                <Tooltip contentStyle={tooltipStyle} formatter={(v: number) => [`${v}%`, "Alcance"]} />
              </PieChart>
            </ResponsiveContainer>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "12px" }}>
            {topHashtags.map((ht, i) => (
              ...
              >
                ...
                <p style={{ fontSize: "13px", fontWeight: 700, color: "#818cf8", marginBottom: "4px" }}>{ht.tag}</p>
